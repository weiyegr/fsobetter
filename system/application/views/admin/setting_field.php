      ...
      <div class="TabbedPanelsContentGroup">
        ...
        <!--添加文章-->
         <div class="tab_content">
		  ...
		  <form class="category" method="post" action="<?php echo base_url(); ?>index.php/admin/setting/add_meta" enctype="multipart/form-data">
		    ...
		    <?php foreach($setting_meta as $li){ ?>
			  ...
			  <?php echo '[<a href="'.base_url().'index.php/admin/setting/del_meta/'.$li['id'].'">删除</a>]'; ?> 标题:<?php echo $li['title']; ?> 字段名:<?php echo $li['fetch']; ?> 类型:
			  <?php 
			  switch($li['type']){
				case 0:
				  echo '文本框';
