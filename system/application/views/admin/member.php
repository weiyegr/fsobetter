    ...
    <div class="main">
     <div id="TabbedPanels1" class="TabbedPanels">
       <ul class="TabbedPanelsTabGroup">
        <li class="TabbedPanelsTab firstTab TabbedPanelsTabSelected" tabindex="0"><div class="left"><div class="right">会员帐号</div></div></li>
       </ul>
        ...
        <div class="TabbedPanelsContent">
         <div class="tab_content">
          <div class="clearfix">
           ...
           <div class="topbtn1">
		       <ul class="btnbg">
			       <li><input type="button" value="添加会员" onclick='location.href="<?php echo base_url(); ?>index.php/admin/member/add_view"' class="btn" /></li>
				   <?php if(get_cookie('adminid')==1){ ?>
				   <li><input type="button" value="编辑字段" onclick='location.href="<?php echo base_url(); ?>index.php/admin/member/field_update"' class="btn" /></li>
				   <?php } ?>
			   </ul>
		   </div>
		   <form class="setting" method="post" action="<?php echo base_url(); ?>index.php/admin/member">
...
<form class="setting" method="post" action="<?php echo base_url(); ?>index.php/admin/member/setting/">          
...
<tbody>
			...
			<tr>
			<td><input type="checkbox" style="margin-left:10px" name="id[]" value="<?php echo $item['uid']; ?>" /></td>
			<td><?php echo $offset+$iii; ?></td>
			<td><?php echo $item['username']; ?></td>
			<td><a href="<?php echo base_url(); ?>index.php/admin/member/edit_view/<?php echo $item['uid']; ?>"><img src="<?php echo $url; ?>images/post_edit.png" /></a> <a href="<?php echo base_url(); ?>index.php/admin/member/remove/<?php echo $item['uid']; ?>" onclick="return confirm('确认要删除?此操作不可恢复!此操作将连同关联附件一同删除!');"><img src="<?php echo $url; ?>images/post_del.png" /></a></td>
			</tr>
			<?php $iii++; } ?>
...
<!--分页-->
  <div class="page">
         ...
         <div class="bottom_info clearfix" id="close1">
		  ...
		  <?php if(get_cookie('adminid')==1){ echo '<p> 返回对象：'.htmlentities('<?php echo $this->classl->member($uid)->username; ?>').'</p>'; } ?>
