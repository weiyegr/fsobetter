      ...
      <div class="TabbedPanelsContentGroup">
        ...
        <!--添加文章-->
         <div class="tab_content">
          ...
          <!--文章标题-->
		  <form id="page" name="page" class="category" method="post" action="<?php echo base_url(); ?>index.php/admin/member/add/" enctype="multipart/form-data">
          <p class="clearfix"><span class="title_text"><label for="title">帐号：</label></span><span class="title_in"><input id="username" type="text" name="username"/></span><span class="tips"></span></p>
		  
		  <p class="clearfix"><span class="title_text"><label for="title">密码：</label></span><span class="title_in"><input id="password" type="text" name="password"/></span><span class="tips"></span></p>
