    ...
    <div class="main">
     <div id="TabbedPanels1" class="TabbedPanels">
       <ul class="TabbedPanelsTabGroup">
        <li class="TabbedPanelsTab firstTab TabbedPanelsTabSelected" tabindex="0"><div class="left"><div class="right">编辑管理员</div></div></li>
      ...
      <div class="TabbedPanelsContentGroup">
        ...
        <!--添加文章-->
         <div class="tab_content">
          ...
          <!--文章标题-->
		  <form class="category" method="post" action="<?php echo base_url(); ?>index.php/admin/admin/update" enctype="multipart/form-data">
          <p class="clearfix"><span class="title_text"><label for="title">帐号名称：</label></span><span class="title_in"><input id="posttitle" type="text" name="user" value="<?php echo $admin->user; ?>"/></span><span class="tips"></span></p>
		  ...
		  <p class="clearfix"><span class="title_text"><label for="title">管理级别：</label></span><span class="title_in"><select id="category_id" class="optioninput" name="ad_id" class="select">
                       <option value="0" <?php if($admin->ad_id==0){echo 'selected="selected"';} ?>>操作员</option>
							<option value="1" <?php if($admin->ad_id==1){echo 'selected="selected"';} ?>>管理员</option>
		  ...
		  <p class="clearfix"><span class="title_text"><label for="title">管理类型：</label></span><span class="title_in"><select id="category_id" class="optioninput" name="admin_id" class="select">
                        <option value="0" <?php if($admin->admin_id==0){echo 'selected="selected"';} ?>>管理</option>
							<option value="1" <?php if($admin->admin_id==1){echo 'selected="selected"';} ?>>制作</option>
                        </select></span><span class="tips"></span></p>
		  <?php } ?>
