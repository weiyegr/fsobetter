    ...
    <div class="main">
     <div id="TabbedPanels1" class="TabbedPanels">
       <ul class="TabbedPanelsTabGroup">
        <li class="TabbedPanelsTab firstTab TabbedPanelsTabSelected" tabindex="0"><div class="left"><div class="right">友情链接</div></div></li>
        <!--<li class="TabbedPanelsTab" tabindex="0"><div class="left"><div class="right">栏目属性</div></div></li>
        <li class="TabbedPanelsTab" tabindex="0"><div class="left"><div class="right">ddddddddddd添加新的栏目</div></div></li>-->
       </ul>
      <div class="TabbedPanelsContentGroup">
        <div class="TabbedPanelsContent">
         <div class="tab_content">
          <div class="clearfix">
		  <form class="setting" method="post" action="<?php echo base_url(); ?>index.php/admin/url/index/">
          <div class="topbtn1"><ul class="btnbg"><li><input type="button" value="添加友情链接" onclick='location.href="<?php echo base_url(); ?>index.php/admin/url/add_url"' class="btn" /></li></ul></div>
          ...
          <form class="setting" method="post" action="<?php echo base_url(); ?>index.php/admin/url/setting">
...
<thead>
  <tr>
    ...
    <th width="50px">编号</th>
    <th width="*" class="thename">网站名称</th>
...
<tbody>
			...
			<td><a href="<?php echo base_url(); ?>index.php/admin/url/update_url/<?php echo $item['id']; ?>"><img src="<?php echo $url; ?>images/post_edit.png" /></a> <a href="<?php echo base_url(); ?>index.php/admin/url/remove/<?php echo $item['id']; ?>" onclick="return confirm('确认要删除?此操作不可恢复!此操作将连同关联附件一同删除!');"><img src="<?php echo $url; ?>images/post_del.png" /></a></td>
			</tr>
			<?php $iii++; } ?>
...
<!--分页-->
  <div class="page">
         ...
         <div class="bottom_info clearfix" id="close1">
		  ...
		  <?php if(get_cookie('adminid')==1){ echo '<p> 返回数组：'.htmlentities('<?php foreach($this->classl->url() as $li){} ?>').'</p>'; } ?>
