            ...
            <div class="contact">
                ...
                <div class="am-u-md-12 am-u-md-5 am-u-lg-5">
                    <div class="contact-left">
                        <h1>
                            <strong class="f-toe">山光威照明科技有限公司</strong>
                            <span class="f-toe">Shan Guangwei Lighting Technology Co. Ltd.</span>
                        </h1>
                        <ul>
                            <li><span>Telephone：</span>0757-85666762  85669652</li>
                            <li><span>Fax：</span>0757-85666762</li>
                            <li><span>Address：</span>Foshan City Industrial Zone water town 8 banana</li>
                            <li><span>Email：</span>fsobetter@yahoo.com</li>
                            <li><span>Website：</span><a href="http://www.fsobetter.com">http://www.fsobetter.com</a></li>
                        </ul>
                    </div>
                </div>
...
<?php $this->load->view('footer'); ?>
    ...
    //标注点数组
    var markerArr = [{title:"山光威照明科技有限公司",content:"佛山市里水镇甘蕉工业区8栋",point:"113.1493013865|23.1878985239",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
		 ];
    //创建marker
    function addMarker(){
